...
export const Enquiry = () => {
  return (
    <section className="px-auto grid lg:grid-cols-5 grid-cols-1 lg:gap-x-12 text-slate-100">
      <div className="lg:col-2 ">
        ...
        >
          ...
          <p className="my-5 lg:mt-10 text-lg text-center md:text-left md:my-5 px-2 lg:px-0 text-slate-200">
