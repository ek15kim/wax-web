...
export const Hero = () => {
  return (
    <div className="overflow-hidden w-full md:h-160 relative">
      <div className="md:absolute top-20 py-5 z-5 md:left-5 px-2 text-white">
        ...
        <div className="md:w-180 py-5 mr-0.5 md:text-xl text-lg flex md:pt-20 flex-wrap gap-10 leading-relaxed">
          ...
          <p className="text-semibold text-xl text-balance">
      ...
      <Image
        className="flex flex-grow-0 basis-full w-full bg-slate-600 opacity-70"
        src="/hero-image.jpg"
        alt="hero"
        width="1600"
        height="300"
